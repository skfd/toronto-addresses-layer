"""Download the Toronto address points GeoJSON from the Open Data portal.

Mirrors the smart-cache pattern of the sibling toronto-addresses-import project,
but stores the cached headers in a small JSON sidecar instead of a database.
"""
...
def download(force=False):
    """Download the latest address points GeoJSON.
